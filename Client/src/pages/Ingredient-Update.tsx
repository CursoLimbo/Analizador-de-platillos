...
import { useUpdateIngredientMutation } from "@/hooks/services/Ingredients";
...
const getIdUrl = () => {
    ...
    const idIndex = currentUrl.lastIndexOf('/') + 1;
    console.log(currentUrl);
    if(currentUrl.substring(idIndex).length>0){
      selectedId = currentUrl.substring(idIndex);
    }
